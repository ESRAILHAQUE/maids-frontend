...
export default function WorkingProcess() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-white py-16 md:py-20">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_12%_10%,rgb(var(--brand-primary-rgb)/0.08),transparent_32%),radial-gradient(circle_at_82%_12%,rgb(var(--brand-primary-rgb)/0.10),transparent_30%)]" />
      ...
      <div className="relative w-[95%]  mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-7">
          {steps.map(({ icon: Icon, title, description }, index) => (
            ...
            >
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-linear-to-br from-[rgb(var(--brand-primary-rgb)/0.10)] via-transparent to-[rgb(var(--brand-primary-rgb)/0.06)] rounded-2xl" />
              <div className="relative space-y-3">
                <div className="flex items-center justify-between">
                  <div className="rounded-xl bg-[rgb(var(--brand-primary-rgb)/0.10)] p-2.5 text-[var(--brand-primary)] ring-1 ring-[rgb(var(--brand-primary-rgb)/0.22)]">
