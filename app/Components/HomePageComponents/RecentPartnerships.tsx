    ...
    <section className="relative isolate overflow-hidden bg-white py-14 md:py-18 text-slate-900">
      ...
      <div className="relative w-[95%] max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col gap-3 text-center mb-8 sm:mb-10">
          <span className="inline-flex items-center justify-center rounded-full bg-[#48C2CB]/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#CF4B00] ring-1 ring-[#48C2CB]/20">
            Recent partnerships
          </span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 md:gap-6">
          {partners.map((partner) => (
            <div
              key={partner}
              className="rounded-xl border border-slate-200 bg-white px-3 py-4 text-center text-sm font-semibold text-slate-900 shadow-[0_12px_40px_rgba(15,23,42,0.08)] transition-all duration-200 hover:-translate-y-1 hover:border-[#CF4B00]/30 hover:shadow-[0_16px_60px_rgba(15,23,42,0.12)]"
            >
              {partner}
            </div>
          ))}
