        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-6 md:gap-8 items-stretch">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 md:p-7 shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
            ...
            <div className="mt-5 flex flex-col sm:flex-row gap-3">
              ...
              <button className="inline-flex items-center justify-center gap-2 rounded-lg bg-slate-900 text-white px-5 py-3 text-sm font-semibold shadow-sm ring-1 ring-slate-200/60 transition-all duration-200 hover:-translate-y-0.5 hover:bg-slate-800">
                Call our team
              </button>
            </div>
          </div>
