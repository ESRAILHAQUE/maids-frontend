...
export default function CommercialCleaningCTA() {
  return (
    <section className="relative isolate overflow-hidden bg-white py-14 md:py-18 text-slate-900">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_15%,rgb(var(--brand-primary-rgb)/0.08),transparent_32%),radial-gradient(circle_at_80%_10%,rgb(var(--brand-primary-rgb)/0.10),transparent_28%)]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] gap-6 md:gap-8 items-center">
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button className="inline-flex items-center justify-center gap-2 rounded-sm cursor-pointer bg-white px-5 py-3 text-sm font-semibold text-slate-900 ring-1 ring-slate-200 transition-all duration-200 hover:-translate-y-0.5 hover:ring-[rgb(var(--brand-primary-rgb)/0.25)]">
